...
The system is designed to run on the legacy 32-bit Debian 11 (Bullseye) with desktop environment. If you run a different OS there may be issues with using the versions of packages installed in step 7. 
